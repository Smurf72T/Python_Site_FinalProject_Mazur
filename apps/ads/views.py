...
from .models import Ad, Message, Notification, RentalRequest, Review
        ...
        if start_date and end_date:
            ...
            if start > end:
                ...
                overlapping = RentalRequest.objects.filter(
                    ...
                    models.Q(start_date__lte=end) & models.Q(end_date__gte=start)
                )
...
def request_detail(request, pk):
    ...
    # Проверка доступа
    if (rental_request.ad.owner != request.user and
